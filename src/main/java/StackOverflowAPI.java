...
public class StackOverflowAPI {
  ...
  public static void getAPI(int n) {
    ...
    String url = "https://api.stackexchange.com/2.3/questions?page=" + n
        + "&pagesize=100&order=desc&sort=votes&tagged=java&site=stackoverflow&filter=!17m5kbq6vrZn4Wg58z4SV(Vbw5s*kwA2JDMubqsLMom62F&key=nQP*qRlOx844vg4pHXAqTA((";
    try {
      URL obj = new URL(url);
